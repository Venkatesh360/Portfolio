    ...
    return (
        <div className="flex flex-col w-full max-w-[600px] items-center justify-center px-4 rounded-lg bg-purple-950/20 gap-y-8 py-4 lg:gap-y-12 shadow-sm shadow-white/70 border-t border-white/70">
            ...
            <div className="flex items-center justify-center w-full gap-8">
                <button className="hover:bg-gray-100 border-2 text-gray-100 hover:text-gray-800 font-semibold py-1 px-2 md:py-2 md:px-4 rounded inline-flex items-center" onClick={downloadResume}>
                    <svg className="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z" />
                    </svg>
                    <span className="flex gap-2"> <span className="hidden sm:block">Download</span> Resume</span>
                </button>
                <button className="hover:bg-gray-100 border-2 text-gray-100 hover:text-gray-800 font-semibold py-1 px-2 md:py-2 md:px-4 rounded inline-flex items-center" onClick={copyToClipboard}>
                    <FaCopy />
